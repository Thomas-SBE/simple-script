...
public abstract class Expression extends Node{
    ...
    public <T> T accept(SimpleScriptASTVisitor<T> visitor) {
        ...
        else if(this instanceof ExpressionIncrement) return visitor.visitExpressionIncrement((ExpressionIncrement) this);
        else if(this instanceof ExpressionIdentifierArray) return visitor.visitExpressionIdentifierArray((ExpressionIdentifierArray) this);
        else{
            return null;
        }
    }
