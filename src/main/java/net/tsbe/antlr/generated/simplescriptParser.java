...
public class simplescriptParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, T__33=34, T__34=35, T__35=36, T__36=37, EOIC=38, ID=39, 
		INT=40, WS=41;
	public static final int
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1649275830768L) != 0)) {
					{
					setState(65);
					expression(0);
					setState(70);
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 675920478208L) != 0)) {
					{
					{
					setState(181);
					instruction();
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 675924672512L) != 0)) {
				{
				setState(210);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
