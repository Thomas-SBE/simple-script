...
public class simplescriptParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, EOIC=34, ID=35, INT=36, WS=37;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, "EOIC", "ID", 
			"INT", "WS"
		};
	}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 103083409656L) != 0)) {
					{
					setState(65);
					expression(0);
					setState(70);
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 41540386816L) != 0)) {
					{
					{
					setState(126);
					instruction();
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 41542483968L) != 0)) {
				{
				setState(154);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
